...
SECRET_KEY = 'django-insecure-tw_&04+^jexe!%s7angxciwcu#*v6xz0o5nse2fqtbm_$hfecy'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR,'myportfpolio/static')]
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "H.V.",  # Marca o nombre del sitio que aparece en la barra de navegación.
    "site_logo": "images/logo.png",  # Ruta relativa al logotipo que aparece en la barra de navegación.
    "welcome_sign": "Bienvenido Hardy Vega",  # Mensaje de bienvenida que aparece en la página de inicio de sesión.
